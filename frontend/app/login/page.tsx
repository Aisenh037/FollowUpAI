      ...
      <div className="max-w-md w-full animate-in">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium text-lg">
            Intelligence at the edge of your pipeline.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-10 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800">
          ...
          <div className="mt-10 text-center">
            <p className="text-slate-500 dark:text-slate-400 font-medium">
              New to FollowUpAI?{' '}
              <Link href="/register" className="text-primary-600 dark:text-primary-400 font-black hover:underline underline-offset-4">
                Create Account
              </Link>
            </p>
          </div>
